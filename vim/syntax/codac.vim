" Vim syntax file
" Language:	Codac (Adapted from c.vim)
...
syn keyword	cStatement	goto break return continue asm readfile
syn keyword	cLabel		case default
syn keyword	cConditional	if else switch
syn keyword	cRepeat		while for do loop
...
syn keyword	cType		int long short void waveform string file

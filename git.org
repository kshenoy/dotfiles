...
This gives rise to the natural terminology of /trunk/ and /branch/. In git, the trunk is commonly referred to as the /master/.
Technically, all branches are equal and there's nothing special about /master/.

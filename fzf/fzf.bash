...
# Setup fzf defaults
if [[ ! "$PATH" == */home/kshenoy/.local/install/fzf/bin* ]]; then
  PATH="${PATH:+${PATH}:}/home/kshenoy/.local/install/fzf/bin"
fi
...
export FZF_DEFAULT_OPTS="--ansi --exit-0 --inline-info --reverse --tiebreak=length,end \
  --bind 'shift-tab:toggle-all,ctrl-/:change-preview-window(down|hidden|)' \

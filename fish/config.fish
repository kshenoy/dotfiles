...
# [[file:~/.config/dotfiles/fish/fish.org::*config.fish][config.fish:1]]
...
# [[file:~/.config/dotfiles/fish/fish.org::*login options][login options:1]]
if status --is-login
...
# [[file:~/.config/dotfiles/fish/fish.org::*login options][login options:2]]
fish_add_path ~/bin

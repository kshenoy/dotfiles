...
_p4_command_() {
    ...
    case "$prev" in
        ...
        annotate)
            ...
            ;;
        branch)
            completions="-f -d -o -i $(_get_branches_)"
            ;;
        change)
        ...
        -t)
            ...
            ;;
        -b)
            completions=$(_get_branches_)
            ;;
        changes)
            completions="... -u"
            ;;
        -u)
            completions=$(_get_users_)
            ;;
        user)
            completions=$(_get_users_)
            ;;
...
complete -o default -F _p4_command_ p4

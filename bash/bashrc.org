...
#+begin_src bash :tangle (when (string-match "buntu" (system-name)) "/tmp/bashrc")
...
:PROPERTIES:
:header-args+: :tangle (when (executable-find "rg") "/tmp/bashrc")
:END:
...
**** ripgrep config file
:PROPERTIES:
:header-args+: :tangle (when (executable-find "rg") "../ripgreprc")
:END:
#+begin_src conf
# This is a tangled file. Do not make any changes here. All changes should preferably be made in the original Org file.
...
*** tmux
#+begin_src bash
source ${XDG_CONFIG_HOME:-$HOME/.config}/dotfiles/tmux/tmux_pp.bash
alias tmux='tmux_pp'
alias tm='tmux'
#+end_src
...
*** home (*buntu)
:PROPERTIES:
:header-args: :tangle (when (string-match "buntu" (system-name)) "/tmp/bashrc")
:END:
